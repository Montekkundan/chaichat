        ...
        <div className="flex min-h-screen flex-col">
            ...
            <div className="mx-auto w-full max-w-[1200px] px-4 md:px-6 lg:px-8">
                <nav className="flex items-center justify-between border-b py-4">
                    <Link href="/" className="font-semibold text-lg hover:underline">← Back to Chats</Link>
                        ...
                        <div className="flex">
                          <TabsList className="flex gap-0.5 rounded-lg bg-muted p-1">
                            <TabsTrigger asChild value="subscription">
                                <Link href="/settings/subscription" className="px-2 py-1 text-sm">Subscription</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="customization">
                                <Link href="/settings/customization" className="px-2 py-1 text-sm">Customization</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="history">
                                <Link href="/settings/history" className="px-2 py-1 text-sm">History</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="models">
                                <Link href="/settings/models" className="px-2 py-1 text-sm">Models</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="api-keys">
                                <Link href="/settings/api-keys" className="px-2 py-1 text-sm">API Keys</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="attachments">
                                <Link href="/settings/attachments" className="px-2 py-1 text-sm">Attachments</Link>
                            </TabsTrigger>
                            <TabsTrigger asChild value="contact">
                                <Link href="/settings/contact" className="px-2 py-1 text-sm">Contact</Link>
                            </TabsTrigger>
                          </TabsList>
                        </div>
                    </Tabs>
