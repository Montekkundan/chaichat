...
export const metadata: Metadata = {
	...
	description: "Experiment with AI models in a flexible playground environment. Test different parameters and configurations.",
	openGraph: {
		title: `Playground - ${APP_NAME}`,
		description: "Experiment with AI models in a flexible playground environment. Test different parameters and configurations.",
		images: [
...
export default async function PlaygroundPage({ params }: { params: Promise<{ playgroundId: string }> }) {
