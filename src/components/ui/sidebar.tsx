...
function SidebarTrigger({
	...
	return (
		<Button
			...
			variant="ghost"
			size="icon"
			className={cn("flex h-7 w-7 items-center justify-center p-0", className)}
			onClick={(event) => {
				onClick?.(event);
				toggleSidebar();
			}}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
	return (
		<main
			...
			className={cn(
				"relative flex w-full flex-1 flex-col rounded-tl-2xl bg-secondary peer-data-[state=collapsed]:rounded-tl-none",
