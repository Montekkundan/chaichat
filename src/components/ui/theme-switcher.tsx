...
export const ThemeSwitcher = () => {
	...
	return (
		<fieldset className="m-0 flex h-8 rounded-[999999px] border border-shadow p-0">
			...
			<div className="mt-[-1px] ml-[-1px]">
				...
				<label
					...
					className={`flex h-8 w-8 cursor-pointer items-center justify-center rounded-[999999px] group${theme === "system" ? " border-shadow border-r" : ""}`}
				>
					...
					>
						...
						<path
							fillRule="evenodd"
							clipRule="evenodd"
							className={`duration-150 group-hover:fill-gray-1000 ${theme === "system" ? "fill-gray-1000 dark:fill-white" : "fill-gray-700 dark:fill-gray-400"}`}
			...
			<div className="mt-[-1px]">
				...
				<label
					...
					className={`flex h-8 w-8 cursor-pointer items-center justify-center rounded-[999999px] group${theme === "light" ? " border border-shadow" : ""}`}
				>
				...
				>
					...
					>
						...
						<path
							...
							className={`duration-150 group-hover:fill-gray-1000 ${theme === "dark" ? "fill-gray-1000 dark:fill-white" : "fill-gray-700 dark:fill-gray-400"}`}
						/>
					</svg>
				</label>
			</div>
